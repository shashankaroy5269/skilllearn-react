        ...
        <div className="about-about-hdr">
          <div className="container">
            <ul className="list-unstyled d-flex mb-0">
              <li>
                <Link to="/" className="brdcrumb fw-light me-1 text-decoration-none">Home {'>'}</Link>
              </li>
          ...
          <div className="container">
            <div className="quize-c-card">
              ...
              <div className="quize-c-cardTop text-center">
                <h1 className="title1 fw-bold text-white">Quiz Compleated</h1>
              ...
              <div className="quize-c-cardBtm">
                ...
                <div className="score-ring">
                  <div className="score-center text-center">
                    <div className="title1">
                      75% <span className="sec-hdr">score</span>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="row">
                    <div className="col-6">
                      <div className="box big-box text-center">
                        ...
                        <div className="sec-hdr m-0 fw-bold">7/8</div>
                      </div>
                    </div>
                    <div className="col-6">
                      <div className="box big-box text-center">
                        ...
                        <div className="sec-hdr m-0 fw-bold">5m 15s</div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="quize-stats">
                  <div className="stat d-flex justify-content-between align-items-center">
                    ...
                    <h3 className="title3 fw-medium mb-0">39 seconds</h3>
                  </div>
                  <div className="stat d-flex justify-content-between align-items-center">
                    <h3 className="title3 fw-medium mb-0">Accuracy rate</h3>
                    <h3 className="title3 fw-medium mb-0">75%</h3>
                  </div>
                  <div className="stat d-flex justify-content-between align-items-center">
                  ...
                  <div className="row g-2">
                    <div className="col-4">
                      <button className="box small-box d-flex flex-column flex-sm-row align-items-center justify-content-center">
                        ...
                        <p className="fw-medium mb-0 ms-0 ms-sm-2">Review Answer</p>
                      </button>
                    </div>
                    <div className="col-4">
                      <button className="box small-box d-flex flex-column flex-sm-row align-items-center justify-content-center">
                        ...
                        <p className="fw-medium mb-0 ms-0 ms-sm-2">Join Discussion</p>
                      </button>
                    </div>
                    <div className="col-4">
                      <button className="box small-box d-flex flex-column flex-sm-row align-items-center justify-content-center">
                  ...
                  <div className="row g-3">
                    <div className="col-12 col-lg-6">
                      <div className="box mid-box d-flex align-items-center p-3">
                        ...
                        <h3 className="title3 mb-0 ms-3">Completed the quiz in record time</h3>
                      </div>
                    </div>
                    <div className="col-12 col-lg-6">
                      <div className="box mid-box d-flex align-items-center p-3">
                        <span className="flex-shrink-0 green-circle" style={{ width: '24px', height: '24px', borderRadius: '50%' }}></span>
                        <h3 className="title3 mb-0 ms-3">Finished the Ultimate World History</h3>
                      </div>
                    </div>
                  </div>
                </div>
