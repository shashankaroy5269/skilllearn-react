              ...
              <div key={index} className={`col-12 col-sm-6 col-lg-4 ${index === 2 ? 'm-auto' : ''}`}>
                <div className="quiz-card">
                  <div className="card-cntn">
                    ...
                    <a href="quiz-qstn.html" className="btn-secondary section-btn text-capitalize">
                      Play Now
                      <span className="d-flex align-items-center justify-content-center">
                  ...
                  <div className="category-card">
                    ...
                    <div className="cardCategory-cntn">
                      ...
                      <div className="categoryCard-btn align-items-center">
                        <a href="quiz-qstn.html" className="btn-secondary section-btn text-capitalize w-100 justify-content-center">
